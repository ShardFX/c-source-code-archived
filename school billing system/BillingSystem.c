    ...
    if(j == 1) {
        while(c == 'y'|| c == 'Y') {
            ...
            if (choice == 1) {
                ...
                while(fread(&stud, sizeof(stud), 1, fs) == 1) {
                    a = 1;
                    if (strcmpi(name, stud.n) == 0 && cl == stud.class) {
                        a = 0;
                        printf("\nenter new name of student: ");
                        fflush(stdin);
                        scanf("%[^\n]", stud.n);
                ...
                while(fread(&stud, sizeof(stud), 1, fs) == 1) {
                    a = 1;
                    if (strcmpi(name, stud.n) == 0 && cl == stud.class && rolno == stud.roll) {
                        a = 0;
                        printf("\nenter new name of student: ");
                        fflush(stdin);
                        scanf("%[^\n]",stud.n);
...
void fee(int mm) {
    ...
    while(c == 'y'|| c == 'Y') {
        ...
        while(fread(&stud, sizeof(stud), 1, f) == 1) {
            if(strcmp(stud.n, name) == 0 && clas == stud.class && roll == stud.roll) {
                a = 0;
